...
router.patch('/instrument/:id', adminCroller.patchInstrument)
...
router.delete('/instrument/:id', adminCroller.deleteInstrument)
...
router.put('/instrument/:id', adminCroller.putInstrument)
router.post('/instrument', adminCroller.postInstrument)
